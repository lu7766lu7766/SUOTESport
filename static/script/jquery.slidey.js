...
(function($) {
    $.slidey = function(el, options) {
        ...
        base.fetchSlides = function() {
            if (base.$el.find("ul").length > 0) {
                base.$el.find("ul").first().children("li").each(function() {
                    var slide = {},
                        $this = $(this);
                    slide.image = ($this.find("img").length > 0) ? $this.find("img").first().attr("src") : -1;
                    if (slide.image === -1) {
                        throw ("Structure error: item has no img tag.");
                    }
                    slide.title = ($this.find("p.title").length > 0) ? $this.find("p.title").first().html() : "";
                    slide.description = ($this.find("p.description").length > 0) ? $this.find("p.description").first().html() : "";
        ...
        base.constructLayout = function() {
            ...
            if (base.options.showList) {
                domdocument += "<div class='slidey-row'><div class='slidey-image col-md-13'><div class='slidey-overlay'>";
            } else {
                domdocument += "<div class='slidey-row'><div class='slidey-image col-md-18'><div class='slidey-overlay'>";
            }
            ...
            domdocument += "</div></div><div class='slidey-list col-md-5'></div></div>";
        ...
        base.prepareNodes = function(){
            ...
            {
                if(base.options.nodeContainer !== "" && $(base.options.nodeContainer).length > 0)
                {
