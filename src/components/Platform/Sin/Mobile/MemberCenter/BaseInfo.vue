        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="tab01-1">
            <div class="act01-form">
              ...
              <div class="form-group">
                <label class="control-label" for="inputNameLarge">{{ $t('nickName') }}</label>
                <input class="form-control" v-model="info.p33_ant_profile_name" id="inputNameLarge" type="text" placeholder="會員暱稱">
              </div>
              <div class="form-group">
                <label class="control-label" for="inputPwdLarge">舊密碼
                  <span class="font-input">(現在的密碼)</span>
                </label>
                <input class="form-control" v-model="info.old_passwd" id="inputPwdLarge" type="password">
              </div>
              <div class="form-group">
                <label class="control-label" for="inputNewPwdLarge">新密碼
                  <span class="font-input">(4~15碼英文數字組合)</span>
                </label>
                <input class="form-control" v-model="info.p33_ant_passwd" id="inputNewPwdLarge" type="password">
              </div>
              <div class="form-group">
                <label class="control-label" for="inputPwdConfirmLarge">再次確認密碼
                  <span class="font-input">(請再次輸入密碼)</span>
                </label>
                <input class="form-control" id="inputPwdConfirmLarge" v-model="info.p33_ant_passwd_confirm" type="password">
              </div>
              <div class="bt-2">
                <div class="member-bt">
                ...
                <div class="member-bt">
                  <button @click="postData()" class="btn btn-default sendBtn">
                    <a>
                      送出
                    </a>
                  </button>
