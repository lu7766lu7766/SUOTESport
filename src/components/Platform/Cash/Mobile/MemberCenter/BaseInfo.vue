<template>
  <section>
    ...
    <div class="lobby-container event">
      <div class="container">
        <div class="col-md-10 col-md-offset-1 form-horizontal member_form">
          <div class="member_title clearfix">
            <ul id="myTab" class="nav nav-tabs tab_list pull-right">
              ...
              <li class="clearfix" :class="{ active: $route.query.s == 'bank' }">
                <a href="#tab2" data-toggle="tab">銀行資訊</a>
              </li>
            </ul>
          </div>
          <div id="myTabContent" class="tab-content" v-if="userInfo.account">
            ...
            <div class="tab-pane fade" :class="{ active: $route.query.s != 'bank', in: $route.query.s != 'bank' }" id="tab1">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" v-model="info.p33_ant_profile_name" class="form-control2">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="text" :value="info.account" class="form-control2" placeholder="(6~15碼英文數字組合)" disabled="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="password" v-model="info.old_passwd" class="form-control2" placeholder="(6~15碼英文數字組合)">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input type="password" v-model="info.p33_ant_passwd" class="form-control2" placeholder="(6~15碼英文數字組合)">
              ...
              <section v-if="myPassBanks.length < 5 && insertBankAccount">
                <div class="banksetting_form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <button type="button" @click="postBankData" class="btn submit_btn">確定送出</button>
                    </div>
