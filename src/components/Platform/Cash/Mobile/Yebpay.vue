    ...
    <div class="page-container">
      ...
      <div class="container">
        <div class="yeb-bg">
          ...
          <div class="yeb-time">
            {{showTime}}
            <span class="time-t">時間</span>
          </div>
          <div class="yeb-interest">
            {{income.toFixed(8) | currency}}
            <span class="unit">點</span>
            <span class="int-t">利息</span>
          </div>
          <div class="yeb-capital">{{wallet | currency}}
            <span class="unit">點</span>
            <span class="cap-t">本金</span>
          </div>
        </div>
        <div class="member_title clearfix">
          <ul id="myTab" class="nav nav-tabs tab_list pull-right">
            <li class="active">
              <a href="#tab1" data-toggle="tab" aria-expanded="true">馬上行動</a>
            </li>
            <li class="">
              <a href="#tab3" data-toggle="tab">異動明細查詢</a>
            </li>
            <li class="clearfix">
              <a href="#tab2" data-toggle="tab" aria-expanded="false">餘額寶說明</a>
            </li>
          </ul>
        </div>
          ...
          <div class="tab-pane fade active in" id="tab1">
            <div class="row">
              <div class="col-md-6">
                <div class="yebbox">
                  <div class="yebtitle">
                    <i><img src="/resource/static/platform-cash/images/y_icon1.png" alt=""></i>
                    <h3>算算餘額寶幫你淨賺多少？</h3>
                    <p>昨日收益：
                  ...
                  <div class="form-group clearfix">
                    <div class="col-md-8"><input v-model="yepayCaculate" type="text" class="form-control2 yeb-form" id="yebpay"></div>
                  </div>
                  <div class="form-group clearfix">
                    <div class="col-md-4">
              ...
              <div class="col-md-6">
                <div class="yebbox">
                  <div class="yebtitle">
                    <i><img src="/resource/static/platform-cash/images/y_icon2.png" alt=""></i>
                    <h3>想賺錢，立即開始！</h3>
                    <p>詳細步驟</p>
                  </div>
                  <ul class="yeb-run-down clearfix">
                    <li><img src="/resource/static/platform-cash/images/yeb-rd1.png" alt="">
                      <p>餘額寶真名</p>
                    </li>
                    <li class="next"></li>
                    <router-link tag="li" :to="{name: 'cash-mobile-point-transform'}">
                    ...
                    <li class="next"></li>
                    <li><img src="/resource/static/platform-cash/images/yeb-rd3.png" alt="">
                      <p>坐享收益</p>
                    </li>
                  </ul>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-3 gosave">
                <div class="form-group">
                  ...
                  <router-link :to="{name: 'cash-mobile-point-transform'}">
                    <button class="yeb_btn">立即生息</button>
                  </router-link>
            ...
            <table class="member_table member_record" cellpadding="0">
              <tbody>
                <tr>
                  <th width="25%">存入日期</th>
                  <th width="25%">存入金額</th>
                  <th width="25%">已存入時間</th>
                  <th width="25%">已產生利息</th>
                </tr>
          ...
          <div class="tab-pane fade" id="tab2">
            <div class="row">
              <div class="col-md-6 text-right">
                <img class="img-responsive" src="/resource/static/platform-cash/images/yeb-ex-img3.png" alt="" />
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-left">
                <img class="img-responsive" src="/resource/static/platform-cash/images/yeb-ex-img1.png" alt="" />
              </div>
            </div>
            <hr class="yeb-line">
            <div class="row">
              <div class="col-md-6 text-right">
                <img class="img-responsive" src="/resource/static/platform-cash/images/yeb-ex-img4.png" alt="" />
              </div>
              <div class="col-md-6 yeb-ex-box">
                <h1>秒秒返利，靈活存取</h1>
            ...
            <div id="myyebTabContent2" class="tab-content">
              <div class="tab-pane fade in active" id="yeb1">
                <p> 1. 轉點至餘額寶請到【
                  <router-link :to="{name: 'cash-mobile-point-transform'}">遊戲幣轉移</router-link>】操作</p>
                ...
                <div class="yebbox">
                  ...
                  <div class="form-group clearfix">
                    <div class="col-md-8"><input v-model="yepayCaculate" type="number" class="form-control2 yeb-form" id="yebpay"></div>
                  </div>
                  <div class="form-group clearfix">
                    <div class="col-md-4">
                      <button class="yeb_btn" @click="caculate">計算收益</button>
